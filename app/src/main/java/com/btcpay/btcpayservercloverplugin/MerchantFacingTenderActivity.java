...
public class MerchantFacingTenderActivity extends Activity {
    ...
    private TextView textAmount, textStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textAmount.setText("Pay with Bitcoin  " + formatAmount(currency, amountCents));
            ...
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    if (qr != null) {
                        ...
                        imageQr.setVisibility(android.view.View.VISIBLE);
                    }
                    startPolling();
                });
            } catch (Exception e) {
